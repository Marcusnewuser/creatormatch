...
function NotificationIcon({ type }: { type: NotificationType }) {
  ...
  switch (type) {
    ...
    case 'new_message':
      ...
      return <MessageSquare className={cn(className, 'text-brand-primary')} />

    case 'file_request':

      return <FileUp className={cn(className, 'text-brand-primary')} />
...
export default function NotificationsPage() {
  ...
  const modeLabel =
    ...
    activeAccountType === 'admin'
      ...
      : activeAccountType === 'brand'

        ? 'Brand'

        : 'Creator'

  const dualRole = hasCreatorProfile && hasBrandProfile && activeAccountType !== 'admin'
    ...
    return (
      ...
      <div className="px-4 pt-6 pb-8">
        ...
        <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
          ...
          Run migration <code className="text-xs">010_notifications.sql</code> in Supabase to enable
          notifications.
    ...
    <div className="px-4 pt-4 pb-8 animate-fade-in">
      ...
      <PageHeader
        ...
        subtitle={
          ...
          unreadCount > 0
            ...
            ? `${modeLabel} workspace · ${unreadCount} unread`

            : `${modeLabel} workspace · All caught up`
      ...
      {dualRole && (
        ...
        <p className="mb-4 text-sm text-text-secondary">
          ...
          Showing {modeLabel.toLowerCase()} notifications only. Switch account type in Settings to

          view your other workspace.
        ...
        <EmptyState
          ...
          description={
            ...
            activeAccountType === 'creator'
              ...
              ? 'Application updates, messages, and collaboration alerts for your creator account appear here.'

              : activeAccountType === 'brand'

                ? 'Applications, content submissions, and campaign updates for your brand account appear here.'

                : 'Platform alerts for administrators appear here.'
